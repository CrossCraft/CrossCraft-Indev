...
namespace CrossCraft {
    ...
    public:
        ...
        auto draw_block(uint8_t id, const mathfu::Vector<float, 3>& position, const mathfu::Vector<float, 3>& rotation) -> void;

        auto draw_item(uint16_t id, const mathfu::Vector<float, 3>& position, const mathfu::Vector<float, 3>& rotation) -> void;

        auto draw_block_hand(unsigned char id, const mathfu::Vector<float, 2>& rotation) -> void;
